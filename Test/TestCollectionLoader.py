...
class TestCollectionLoader(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        """Class setup method. Sets up collection loader."""
        cls.collection_path = os.path.join(RESOURCES_PATH, "collection.tar.gz")
        cls.chunk_size = 1000  # Small chunk size for testing
    ...
    def test_process_chunks_iterator(self):
        ...
        for chunk in self.loader.process_chunks():
            ...
            # Default names. Loading in setup was default.
    ...
    def test_sample_lines(self):
        """Test the method to randomly sample lines."""
        num_samples = 10
