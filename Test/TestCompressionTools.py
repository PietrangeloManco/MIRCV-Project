...
class TestCompressionTools(unittest.TestCase):
    ...
    def test_pfor_delta_compress_decompress(self):
        ...
        for doc_ids, frequencies in test_cases:
            with self.subTest(doc_ids=doc_ids, frequencies=frequencies):
                ...
                decompressed_doc_ids, decompressed_frequencies = CompressionTools.pfor_delta_decompress(compressed_data)
    ...
    def test_mismatched_doc_ids_and_frequencies(self):
        ...
        with self.assertRaises(ValueError):
            CompressionTools.pfor_delta_compress([1, 5], [2])  # Mismatched lengths
